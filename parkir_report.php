            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="17%">No Polisi</th><th>Jenis</th><th width="15%">Merk</th><th width="15%">Warna</th><th width="20%">Tarif</th><th>AKSI</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                <td colspan="9">
                                    <a href="report/arsip_semua.php" target="_blank" class="btn btn-info btn-sm">
                                        <span class="fa fa_print"></span> Cetak Semua Parkir
